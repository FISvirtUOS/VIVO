...
<p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber (virtUOS). Kontaktdaten können Sie dem Impressum dieser Website entnehmen.</p>
...
<h3>2. Hinweise und Pflichtinformationen</h3>
<h4>Datenschutz</h4>
...
<p>Wir weisen darauf hin, dass die Datenübertragung im Internet (zum Beispiel) bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich. </p>
...
<h4>Widerruf Ihrer Einwilligung zur Datenverarbeitung</h4><p>Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per <a href="mailto:fis@uni-osnabrueck.de" title="E-Mail schreiben" class="mail">E-Mail</a> an uns. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.</p><h4><strong>Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</strong></h4>
...
<h4>Gesetzlich vorgeschriebener Datenschutzbeauftragter</h4><p>Wir haben für unsere Universität einen behördlichen Datenschutzbeauftragten bestellt:
</p>
<p>Dipl.-Kfm. Björn Voitel<br />
  ...
  49069 Osnabrück<br />
  Telefon: +49 541 969 - 4559<br />
  <a href="mailto:datenschutzbeauftragter@uni-osnabrueck.de" title="E-Mail schreiben" class="mail">datenschutzbeauftragter@uni-osnabrueck.de</a> </p>
