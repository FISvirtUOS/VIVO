...
<#else>
    ${dt.formatXsdDateTimeShort(statement.dateTime, statement.precision!)}
    <@lmt.addCitationMetaTag uri="http://vivoweb.org/ontology/core#dateTimeValue" content=dt.formatXsdDateTimeShort(statement.dateTime, statement.precision!) />
</#if>
